...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'date_approve'        => 'Дата утверждение',
        'file'                => 'Файл',
        'dynamic'                => 'Динамическая версия',
        'agent'                => 'Контрагент',
        'amount'                => 'Сумма',
        'status'                => 'Статус',
        ...
        'text' => 'Текст',
        'region_id' => 'Регион',
        'ud_num' => '№ удостоверения личности',
        'ud_expired' => 'Дата выдачи удостоверения личности',
        'ud_issued_id' => 'Орган выдачи удостоверения личности',
        'client_type_id' => 'Физ./Юр. лицо',

        'vin' => 'VIN',
        'grnz' => 'ГРНЗ',
        'm_model' => 'Марка, модель',
        'body_no' => '№ кузова',
        'chassis_no' => '№ шасси',
