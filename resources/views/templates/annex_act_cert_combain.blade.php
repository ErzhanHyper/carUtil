...
<table class="bordered" width="100%" cellspacing="0">
    ...
    <tbody>
        ...
        <tr><td>2</td><td>Трансмиссия (ведущий мост, задняя балка)</td><td>&nbsp;{{ $data['VL_2'] }}</td><td>&nbsp;</td></tr>
        <tr><td>3</td><td>Двигатель</td><td>&nbsp;{{ $data['VL_3'] }}</td><td>&nbsp;</td></tr>
        <tr><td>4</td><td>Корпус</td><td>&nbsp;{{ $data['VL_4'] }}</td><td> </td></tr>
        <tr><td>5</td><td>Бункер</td><td>&nbsp;{{ $data['VL_5'] }}</td><td>&nbsp;</td></tr>
        <tr><td>6</td><td>Шины (при наличии)</td><td>&nbsp;{{ $data['VL_6'] }}</td><td>&nbsp;</td></tr>
        <tr><td>7</td><td>Колесные диски (при наличии)</td><td>&nbsp;{{ $data['VL_7'] }}</td><td>&nbsp;</td></tr>
        <tr><td>8</td><td>Аккумуляторные батареи (при наличии)</td><td>&nbsp;{{ $data['VL_8'] }}</td><td>&nbsp;</td></tr>
        <tr><td>9</td><td>Вес:</td><td>&nbsp;</td><td></td></tr>
        <tr><td>9.1</td><td>Килограмм</td><td>&nbsp;{{ $data['weight'] }}</td><td></td></tr>
        <tr><td>9.2</td><td>Процент (%) от заводской массы</td><td>&nbsp;{{ $data['percent_of_original_weight'] }}</td><td></td></tr>
    </tbody>
</table>
