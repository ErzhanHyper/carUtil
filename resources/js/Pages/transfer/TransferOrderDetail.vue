<template>
    ...
    <div class="q-gutter-sm q-mb-sm q-mt-xs text-right">
            <q-btn icon="close" color="negative"
                   label="Удалить" @click="removeTransfer"/>
    </div>
    ...
    <template v-if="item.dealExist">
        <div class="q-mx-md q-mt-md flex justify-between">
            <div>
                ...
                <q-chip class="q-mt-md text-body1" color="green-1" square v-if="item.closed === 1 && item.deal && !item.deal.signed">Сделка
                    выбрана
                </q-chip>
            ...
            <div v-if="item.deal">
                ...
                <q-btn label="Скачать договор" color="deep-orange-10" size="12px" class="q-mt-sm" icon="picture_as_pdf"
    ...
    <div class="row q-col-gutter-md" v-if="show && !item.isOwner">
            ...
            <q-card flat>
                <q-card-section>
                    <div class="q-gutter-md">
                        ...
                        <q-input label="Дата одобрение" v-model="item.order.created" :readonly="true" outlined dense/>
